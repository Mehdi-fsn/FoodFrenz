...
class Dimensions {
  ...
  static double height12 = screenHeight / 72.25;
  ...
  static double height80 = screenHeight / 10.83;
  static double height100 = screenHeight / 8.67;
  static double height110 = screenHeight / 7.78;
  ...
  static double height240 = screenHeight / 3.61;
  ...
  static double textSize13 = 13.0.sp;
  ...
  static double iconSizeLarge = 18.0.sp;
  static double iconSizeExtraLarge = 20.0.sp;
  static double iconSize30 = 30.0.sp;
  ...
  static double radius120 = screenHeight / 7.22;
